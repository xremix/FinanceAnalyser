...
Try out the [Demo](http://finanz-uhu.xremix.de/) with the [Demo CSV](https://raw.githubusercontent.com/xremix/FinanceAnalyser/main/demo.csv) and see the functionality of the App.
