  ...
  },
  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        type: 'expense',
        excludeKeywords: [],
        keywords: ['Apotheke', 'Arzt', 'Brille', 'Optiker', 'Osteopath'],
      },
      {
        name: 'Weitere',
...

  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        subCategories: [],
        type: 'expense',
        keywords: ['Auto', 'Autohaus', 'Kennzeichen', 'Mietwagen', 'Waschstrasse', 'Audi', 'BMW', 'Cupra', 'Mercedes', 'Opel', 'Seat', 'Porsche', 'VW', 'Volkswagen'],
        excludeKeywords: [],
      },
      {
        name: 'Fahrrad',
